...
## Summary
- 337 nodes · 756 edges · 18 communities (16 shown, 2 thin omitted)
...
Cohesion: 0.19
Nodes (13): llamarMozo(), registrarEmpresa(), RegistroModal(), NotificationContext, NotificationProvider(), TYPE_ICONS, useNotify(), ESTADO_COLORS (+5 more)
...
### Community 5 - "App.jsx"
Cohesion: 0.08
Nodes (35): crearPreferencia(), createPedido(), getMenu(), validarCupon(), App(), defaultRouteForRole(), DemoModal(), Navbar() (+27 more)
...
### Community 15 - "CocinaPage.jsx"
Cohesion: 0.11
Nodes (25): atenderLlamado(), getEmpresa(), getLlamados(), login(), getBase(), useSSE(), ThemeToggle(), AdminSidebar() (+17 more)
...
- **Why does `request()` connect `client.js` to `PedidoTrackingPage.jsx`, `mock.js`, `ARViewer.jsx`, `App.jsx`, `PlanoEditor.jsx`, `adminUtils.js`, `CocinaPage.jsx`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useCompany()` connect `App.jsx` to `PedidoTrackingPage.jsx`, `client.js`, `PlanoEditor.jsx`, `CocinaPage.jsx`?**
