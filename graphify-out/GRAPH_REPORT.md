...
## Summary
- 340 nodes · 770 edges · 17 communities (15 shown, 2 thin omitted)
...
Cohesion: 0.13
Nodes (28): createCupon(), createPlato(), createStaff(), deleteCupon(), deletePlato(), deleteStaff(), getCupones(), getEmpresaSlug() (+20 more)

### Community 5 - "App.jsx"
Cohesion: 0.06
Nodes (46): crearPreferencia(), createPedido(), getMenu(), getMesas(), validarCupon(), App(), defaultRouteForRole(), DemoModal() (+38 more)
...
Cohesion: 0.24
Nodes (15): getPedidosRango(), AdminMenuView(), AdminMetricasView(), AdminPedidosView(), FILTROS, hoyLocal(), calcularMetricas(), CATE_LABELS (+7 more)

### Community 13 - "CompanyContext.jsx"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (39): atenderLlamado(), cancelarPedido(), getLlamados(), getMetricas(), getPedidos(), getPlatos(), logout(), reordenarPlatos() (+31 more)
...
- **Why does `request()` connect `client.js` to `PedidoTrackingPage.jsx`, `mock.js`, `App.jsx`, `PlanoEditor.jsx`, `adminUtils.js`, `CompanyContext.jsx`, `AdminPage.jsx`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useCompany()` connect `App.jsx` to `PedidoTrackingPage.jsx`, `PlanoEditor.jsx`, `CompanyContext.jsx`, `AdminPage.jsx`?**
